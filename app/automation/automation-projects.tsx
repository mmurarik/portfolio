...
const projects = [
  {
    ...
    stack: ['LLM evaluation', 'Python', 'Statistical validation', 'Human review'], href: '/llm-evaluation/ai-judging-panel',
  },
  {
  ...
  },
  {
    ...
    stack: ['Python', 'Data validation', 'Synthetic fixtures', 'Configuration'],
  },
  {
    ...
    stack: ['Python', 'Contentful API', 'Excel', 'Read-only access'],
  },
  {
    ...
    stack: ['Python', 'Excel', 'Contentful API', 'Result logging'],
  },
  {
    ...
    stack: ['Alteryx', 'Alchemer', 'OpenAI API', 'Contentful API'],
  },
  {
    ...
    stack: ['Python', 'Cvent API', 'Contentful API', 'Validation'],
  },
  {
    ...
    stack: ['Python', 'Alchemer', 'ClickUp API', 'Data cleaning'],
  },
  {
    ...
    stack: ['Alteryx', 'BigQuery', 'Tableau', 'APIs'],
  },
  {
    ...
    stack: ['Claude Code skills', 'YAML', 'GitHub', 'Runbooks', 'Decision records'],
  },
  {
    ...
    stack: ['CSS', 'Chrome DevTools', 'Alchemer', 'Claude Code skill'],
  },
  {
    ...
    stack: ['Python', 'ClickUp API', 'Alchemer'],
  },
  {
    ...
    stack: ['Claude Code skills', 'ClickUp'],
  },
  {
    ...
    stack: ['Claude Code skills', 'Survey reporting', 'Dashboard preparation'],
  },
];
